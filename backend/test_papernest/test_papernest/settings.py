...
ROOT_URLCONF = 'test_papernest.urls'
...
ASGI_APPLICATION = 'test_papernest.asgi.application'
WSGI_APPLICATION = 'test_papernest.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'coverage_api.log'),
            'formatter': 'verbose',
        }
    },
    'loggers': {
...
# Configuration Swagger mise à jour
SWAGGER_SETTINGS = {
